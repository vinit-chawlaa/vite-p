...
const About = () => {
  return (
    <div className="w-full lg:px-20 px-10 py-10" id="about">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center justify-items-center">
        <div>
          ...
          <p className="text-md pt-10 pb-5 leading-8">
