...
const About = () => {
  return (
    <div className="w-full lg:px-20 px-5 py-10" id="about">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center justify-items-center">
        <div>
          <motion.h1 className="text-5xl" viewport={{ once: true }} initial={{y : -100 , opacity : 0}} whileInView={{y : 0 , opacity : 1}} transition={{duration : 0.5}}>
          ...
          <motion.p whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : -100, opacity : 0}} transition={{duration : 0.3}} className="text-md pt-10 pb-5 leading-8">
  ...
  <motion.div whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : -100, opacity : 0}} transition={{duration : 0.5}} className="flex items-center gap-6">
  ...
  <motion.div whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : -100, opacity : 0}} transition={{duration : 0.8}} className="flex items-center gap-6">
  ...
  <motion.div whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : -100, opacity : 0}} transition={{duration : 1}} className="flex items-center gap-6">
  ...
  <motion.div whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : -100, opacity : 0}} transition={{duration : 1.2}} className="flex items-center gap-6">
    ...
    <span className="w-[50%] h-4 bg-gradient-to-r from-pink-500 via-orange-400 to-yellow-300  rounded-full"></span>
         ...
         <motion.div whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : -100, opacity : 0}} transition={{duration : 1.4}}>
        ...
        <div>
        <motion.img src='/hero.jpeg' whileInView={{opacity : 1 , x : 0}} viewport={{ once: true }} initial={{x : 100, opacity : 0}} transition={{duration : 0.5}}  width={500} height={100} className='animate-[float_3s_ease-in-out_infinite] rounded-full shadow-[0_0_30px_20px_rgba(88,28,135,0.6)] transition duration-500 hover:shadow-[0_0_40px_20px_rgba(139,92,246,0.8)] border-5 border-purple-500 cursor-pointer' alt='not found'/>
        </div>
      </div>
    </div>
  );
